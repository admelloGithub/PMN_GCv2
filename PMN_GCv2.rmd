...
output_directory <- "/Users/admello/OneDrive - University of Maryland School of Medicine/Desktop/PGAMR_paper/output/"
```
...
#Swap between main figure heatmap database and supplemental db by commenting in/out lines 321 & 322

```{r}

regdb <- readLines(paste0(input_directory,"/GCVenn_130.db"))
#regdb <- readLines(paste0(input_directory,"/GCVenn_130_supp.db"))
...
regdb <- readLines(paste0(input_directory,"/GCVenn_H041.db"))
#regdb <- readLines(paste0(input_directory,"/GCVenn_H041_supp.db"))
...
aka2 = data.frame(Condition = factor(c("H041_1h","H041_1h","H041_1h","H041_1h","H041PMN_0h","H041PMN_0h","H041PMN_0h","H041PMN_0h","H041PMN_0h","H041PMN_0h","H041PMN_1h","H041PMN_1h","H041PMN_1h","H041PMN_1h","H041PMN_1h","H041PMN_1h")))
rownames(aka2)<-colnames(counts.vsd)
...
regdb <- readLines(paste0(input_directory,"/GCVenn_Host.db"))
isHdr <- grepl("#", regdb)
grp <- regdb[isHdr][cumsum(isHdr)]
Read <- function(x) read.table(text = x, sep = "\t", fill = TRUE, comment = "#")
regs <- Map(Read, split(regdb, grp))
